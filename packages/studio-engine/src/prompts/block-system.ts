...
- Motion is STAGED (≥2 stages, hero lands last) and uses ≥2 devices — not a single fade; then everything holds still. With SPOKEN BEATS, no later content is visible before the beat that first mentions it. Selectors scoped, timing local.
