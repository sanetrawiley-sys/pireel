...
export const MCP_DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  read_frame:
    "Read a Frame's rich visual-directing playbook: design tokens, footage relationship, composition grammar, density, typography, motion and review judgment. Call it after attach_frame, read it as a whole, and adapt its language to each Scene's purpose and evidence. It is not a set of fixed output types or block recipes. Requires frame_id (ids via list_frames).",
