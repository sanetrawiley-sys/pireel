...
export const MCP_DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  read_frame:
    "Read a visual direction's art-direction playbook: shape language, material and image treatment, typography personality, spatial composition and motion grammar. The latest user instruction and current manually configured project values are authoritative; never reset palette, captions, layout, crop or placement to fit the Frame. The Skill and Director still own story, evidence and Scene strategy. Requires frame_id (ids via list_frames).",
